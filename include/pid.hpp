...
namespace pid
{
  ...
  public:
    ...
    // Standard constructor
    Controller2(bool angle, double Kp, double Kd)
    {
      angle_ = angle;
      Kp_ = Kp;
      Kd_ = Kd;
    ...
    void set_coefficients(double Kp, double Kd)
    {
      Kp_ = Kp;
      Kd_ = Kd;
    }
    ...
    // Run one calculation
    double calc(double y_target, double y_actual, double y_dot_target, double y_dot_actual)
    {
      ...
      return Kp_ * y_error + Kd_ * y_dot_error;
    }
  };
